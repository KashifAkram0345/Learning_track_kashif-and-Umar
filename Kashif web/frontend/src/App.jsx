...
const STORAGE_USER_KEY = 'kashif-user'
const STORAGE_USERS_KEY = 'kashif-active-users'
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:5000'
const GOOGLE_CLIENT_ID = import.meta.env.VITE_GOOGLE_CLIENT_ID || ''
const DEFAULT_PRODUCT_IMAGE = 'data:image/svg+xml;charset=UTF-8,%3Csvg xmlns="http://www.w3.org/2000/svg" width="520" height="360" viewBox="0 0 520 360"%3E%3Crect width="520" height="360" fill="%23e2e8f0"/%3E%3Ctext x="50%25" y="50%25" dominant-baseline="middle" text-anchor="middle" font-family="Arial, sans-serif" font-size="24" fill="%23738a9d"%3EImage not available%3C/text%3E%3C/svg%3E'
...
function App() {
  ...
  const [theme, setTheme] = useState(() => {
    ...
    return localStorage.getItem('kashif-theme') || 'light'
  })
  ...
  useEffect(() => {
    ...
    localStorage.setItem('kashif-theme', theme)
  }, [theme])
    ...
    return (
      <div className="auth-shell">
        <div className="auth-card">
          ...
          <h1>{authMode === 'signin' ? 'Sign in to Kashif Store' : 'Join Kashif Store'}</h1>
